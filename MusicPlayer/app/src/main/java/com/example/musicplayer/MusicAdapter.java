...
public class MusicAdapter extends RecyclerView.Adapter<MusicAdapter.MyViewHolder> implements Filterable {
    ...
    private List<MusicList> currentList, fullList;
    ...
    private Filter filter = new Filter() {
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            currentList.clear();
            currentList.addAll((List<MusicList>)results.values);
    ...
    public void onBindViewHolder(@NonNull MusicAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        MusicList list2 = currentList.get(position);
        ...
        holder.musicDuration.setText(list2.getDurationAsString());
        ...
        holder.rootLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //currentList.get(playingPosition).setPlaying(false);
                ...
                songChangeListener.onChanged(list2);
                notifyDataSetChanged();
